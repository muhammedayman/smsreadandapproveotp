...
class MainActivity : Activity() {
    ...
    private val apiDebugReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            ...
            if (intent?.action == "com.mamstricks.readsms.API_DEBUG") {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            try {
                registerReceiver(refreshReceiver, IntentFilter("com.mamstricks.readsms.UPDATE_LIST"))
                ContextCompat.registerReceiver(this, apiDebugReceiver, IntentFilter("com.mamstricks.readsms.API_DEBUG"), ContextCompat.RECEIVER_NOT_EXPORTED)
            } catch (e: Exception) {
